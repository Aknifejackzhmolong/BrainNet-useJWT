...
public enum ResultEnum {
    ...
    EXCEPTION(500, ""),
    NULL_ATTR(101,"属性为空"),
    AUTHORIZATION_REQUIRED(401,"需要Authorization"),
    ...
    REGISTER_ACCOUNT_EXISTED(2003, "注册账户已存在"),
    REGISTER_VERIFYCODE_EMPTY(2003, "邮箱验证码未发送"),
    REGISTER_VERIFYCODE_ERROR(2003, "邮箱验证码错误"),
